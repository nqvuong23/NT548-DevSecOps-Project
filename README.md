...
![Hình 1. DevSecOps Pipeline](./docs/pipeline_v3.png)
...
- Commit GitOps do Jenkins tạo có hậu tố `[skip ci]`; Jenkinsfile sẽ checkout rồi skip các stage scan/build/deploy để tránh vòng lặp build lại chính commit cập nhật image tag.
